    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h4 class="page-header">Eliminar Comentario </h4>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                    ...
                    <form class="form-horizontal" action="delete-comentario.php" method="post">
	    			  <input type="hidden" name="id" value="<?php echo $id;?>"/>
					  
					  <div class="form-actions">
						  <button type="submit" class="btn btn-danger">Si</button>
						  <a class="btn btn-default" href="comentario.php">No</a>
						</div>
					</form>
                </div>
            </div>
