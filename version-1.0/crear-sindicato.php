...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a class="active" href="#"><i class="fa fa-edit fa-fw"></i> Sindicato<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">                              
                                <li>
                                    <a class="active" href="crear-sindicato.php">Crear Sindicato</a>
                                </li>
                                <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Datos Nuevo de Sindicato</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->        
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class=" panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                <div class="col-lg-6">
                                <form role="form" action="recibir-sindicato.php" method="get">
                                    <div class="form-group">
                                            <label>Nombre</label>
                                            <input type="text" class="form-control"name="nombre" id="nombre"placeholder="Introduzca nombre de sindicato">
                                            <p class="help-block">Ejemplo: Simon Bolivar, Contranstour.</p>
                                    </div>
                                    <?php
                                    ...
                                    <div class="form-group">
                                            ...
                                            <p class="help-block">Ejemplo c/ Aguilar #23 z/ 16 de julio.</p>
                                    </div>
                                    <div class="form-group">
                                            <label>Telefono</label>
                                            <input type="text" class="form-control" name="telefono" id="telefono" placeholder="Telefono">
                                            <p class="help-block">Ejemplo: 76543210 (sin código de ciudad).</p>
                                    </div>
                                    <button type="submit" onclick="guarda_sindicato();" value="Guardar" class="btn btn-primary">Guardar</button>
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">Lista de Sindicatos</div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                    <?php
