...
function pasar_paradas_a_div()
{
    ...
    cc+="<label  style='width: 55%;float: left;'>tiempo de duracion del tramo  : "+(tt/60)+"</label>";
    cc+="<label  style='width: 55%;float: left;'>cantidad de paradas  : "+vector_markes.length+"</label>";
    cc+="<table border =1px style='width: 100%;'>";
    cc=cc+"<tr><td><i>codigo</i></td><td><i>tiempo en minutos</i></td> <td><i>trazo</i></td></tr>";
    var t=0;
    for(var i=0;i<vector_markes.length;i++){
        t=t+tiempo[i];
