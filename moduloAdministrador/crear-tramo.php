...
<head>
    ...
    <script type="text/javascript" src="js/codigo-tramo.js"></script>
    <script>
...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a class="active" href="#"><i class="fa fa-play fa-fw"></i> Tramo<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a class="active" href="crear-tramo.php"> Crear Tramo</a>
                                </li>
                                <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Datos de Nuevo Tramo</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
